...
@Configuration
@EnableJpaRepositories(basePackages = {"com.planner.trip.repository"},transactionManagerRef = "jpaTransactionManager")//다른 모듈 Repo 스캔중
...
public class JpaConfig {
    ...
    @Bean
    public PlatformTransactionManager jpaTransactionManager(EntityManagerFactory managerFactory){//트랜잭션
